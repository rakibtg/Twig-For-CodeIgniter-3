...
class Twig
{
    ...
    {
        log_message('debug', 'Twig For Codeigniter: library initialized');

        $this->CI =& get_instance();

        $this->_config = $this->CI->config->item('twig_conf');
        ...
        {
            log_message('error', 'Twig For Codeigniter: failed to load the default theme');
    ...
    */          
    ...
    public function theme($theme)
    {
        ...
        {
            log_message('error', 'Twig For Codeigniter: requested theme '. $theme .' has not been loaded because it does not exist.');
